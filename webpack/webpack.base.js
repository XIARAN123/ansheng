...
var entryJSpages = glob.sync(`./src/script/${config.entryDirectory}/entry/*.js`).reduce(function (prev, curr) {
  console.log(333, curr.slice(30, -3))
  if (process.env.NODE_ENV === 'development') {
    prev[curr.slice(30, -3)] = [curr, hotMiddlewareScript];
  } else {
    prev[curr.slice(30, -3)] = [curr];
  }
  return prev;
}, {});
...
module.exports = {
  ...
  module: {
    ...
    //     include: [resolve('src'), 'node build/dev-serve.js'], //限制范围，提高打包速度
    //     exclude: /node_modules/
    // },
    {
      test: /\.css$/,
    ...
    // {
    //     test: /\.scss$/,
    //     use: ['css-hot-loader', MiniCssExtractPlugin.loader, 'css-loader', 'postcss-loader', 'sass-loader', 'vue-style-loader'],
    //     include: [resolve('src')],
    //     exclude: /node_modules/
    // },
